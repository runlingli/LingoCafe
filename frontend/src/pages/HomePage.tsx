...
const HomePage = () => {
  ...
  return (
    <AppLayout
      header={
        <MainHeader
          headline="LingoCafe · Where language learners thrive"
    ...
    >
      ...
      <div className={styles.masonry}>
        ...
        {loading ? <div className={styles.masonryItem}><div>Loading…</div></div> : null}
        {!loading && items.length === 0 ? (
          <div className={styles.masonryItem}><div>No content yet</div></div>
        ) : null}
      </div>
    </AppLayout>
  );
