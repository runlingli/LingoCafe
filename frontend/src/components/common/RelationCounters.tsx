    ...
    <>
      {counts ? (
        <div className={styles.wrapper}>
          ...
          <div className={styles.item}><span className={styles.number}>{counts.posts}</span><span className={styles.label}>Posts</span></div>
          <div className={styles.item}><span className={styles.number}>{counts.likedPosts}</span><span className={styles.label}>Likes</span></div>
          <div className={styles.item}><span className={styles.number}>{counts.favedPosts}</span><span className={styles.label}>Saved</span></div>
        </div>
      ) : null}
